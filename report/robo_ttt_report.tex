...
\subtitle{Test-Time Training for Robot Policies —— 61 篇文献调研汇总}
...
\titlepage
\begin{center}
\small 61 篇论文 · 7 大分类 · 英文 PDF + 中文翻译 + 逐篇精读 · 7 大趋势 + 5 条洞见\\
...
⑤ 免权重 Steering & 不改权重的引导/搜索/验证 & DSRL · TOAD · GTRS · DriveCritic & 18\\
⑥ 2025--2026 前沿 & 可靠性协议 / 算力调度 / PRM & VANE · ELASTIC · DREAM-Chunk & 8\\
⑦ 免梯度上下文适应 & 演示进上下文，零梯度快适应 & ICRT · InstantPolicy · RICL & 3\\
\bottomrule
\end{tabular}
\vspace{6pt}
