...
**H9 残差的最后一个候选：训练 seed 方差**。所有点的轴 3–5 都只来自训练 seed 42；E4 三个 seed 的终值是 95/98/77.5。E4/E5 低于趋势线可能只是 seed 42 的运气。seed 43/44 的 E4/E5 checkpoint 在 ×0.7 下的冻结评测已启动（`run_seed_robust.sh`，24 组），这将给出轴 4 的 seed 方差——若 E4 seed 43/44 的 ×0.7 落到 40–50%，E4 的偏低就是 seed 噪声，H9 的残差归零；若仍 ≈28，则第二因子仍待找。
